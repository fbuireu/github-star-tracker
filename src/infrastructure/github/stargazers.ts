...
function warnWhenHistoryIsUnreconstructable({ repo, stargazers }: WarnWhenHistoryIsUnreconstructableParams): void {
...
async function fetchStargazerPage({ octokit, owner, name, page }: FetchStargazerPageParams): Promise<Stargazer[]> {
