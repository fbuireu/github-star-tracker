...
export function diffStargazers({ current, previousMap }: DiffStargazersParams): StargazerDiffResult {
...
export function buildStargazerMap({ repoStargazers, previousMap }: BuildStargazerMapParams): StargazerMap {
