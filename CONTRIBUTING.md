...
2. **Install dependencies**
   ...
   `packageManager` and in that same [`CLAUDE.md`](./CLAUDE.md) section.
...
[`CODE_OF_CONDUCT.md`](./CODE_OF_CONDUCT.md). If you edit any of them, the test reads what you wrote.
