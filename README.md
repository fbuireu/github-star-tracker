...
flowchart TD
    ...
    style setup fill:#fff8e1,stroke:#f57f17,stroke-width:2px,color:#000,font-weight:bold,font-size:15px
    style analysis fill:#f3e5f5,stroke:#6a1b9a,stroke-width:2px,color:#000,font-weight:bold,font-size:15px
    style artifacts fill:#e8f5e9,stroke:#2e7d32,stroke-width:2px,color:#000,font-weight:bold,font-size:15px
    style persist fill:#fce4ec,stroke:#ad1457,stroke-width:2px,color:#000,font-weight:bold,font-size:15px
```
...
graph TD
    ...
    style main fill:#e1f5fe,stroke:#0277bd,stroke-width:2px,color:#000,font-weight:bold,font-size:15px
    style data fill:#fff8e1,stroke:#f57f17,stroke-width:2px,color:#000,font-weight:bold,font-size:15px
```
