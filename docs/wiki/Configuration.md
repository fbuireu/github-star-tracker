...
See the **[examples gallery](https://github.com/fbuireu/github-star-tracker/blob/main/docs/examples/README.md#curve-styles-chart-curve)** for a rendered comparison.
