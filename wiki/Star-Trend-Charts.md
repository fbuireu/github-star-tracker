...
**Note:** URLs contain all chart data — no API key or external data source needed.
...
1. **First run** — Need at least 2 data points
2. **Charts disabled** — Check `include-charts: true`
3. **Image blocking** — Email client or browser blocking external images
4. **Malformed URL** — Check workflow logs for errors
...
- **[Viewing Reports](Viewing-Reports)** — How to access your charts
- **[Email Notifications](Email-Notifications)** — Include charts in emails
